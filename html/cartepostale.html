...
<head> <!-- La balise head anglobe tout ce qui n'apparaîtra pas dans notre page Web-->
    <title>Ville d'Angoulême - Carte Postale</title> <!-- On définit le titre-->
    ...
    <link rel="stylesheet" href="../css/article.css"><!-- On link la page html avec la page css afin d'ajouter de l'esthétique à notre page WEB -->
